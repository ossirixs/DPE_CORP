...
def get_result_descriptions(max_object):
    ...
    if result_descriptions["C"]["percentage"] ==67: result_descriptions["C"]["description"]=" Muy organizado, trata de estar con todo su material siempre en orden."
    ...
    if result_descriptions["D"]["percentage"] ==67: result_descriptions["D"]["description"]=" Le agrada realizar trabajos que exijan atención en detalles."
    ...
    if result_descriptions["G"]["percentage"] ==45: result_descriptions["G"]["description"]=" Identificación regular con trabajos difíciles. "
    ...
    if result_descriptions["K"]["percentage"] ==89: result_descriptions["K"]["description"]=" Persona que se opone y enfrenta franca y abiertamente a los otros."
    ...
    if result_descriptions["O"]["percentage"] <11: result_descriptions["O"]["description"]=" Dificultad en su relacionamiento, es muy formal.  "
    ...
    if result_descriptions["R"]["percentage"] <11: result_descriptions["R"]["description"]=" Ninguna preocupación en planificación."
    ...
    if result_descriptions["R"]["percentage"] ==45: result_descriptions["R"]["description"]=" Prefiere planificar y formular estrategias 40 a 50% del tiempo."
    ...
    if result_descriptions["R"]["percentage"] ==67: result_descriptions["R"]["description"]=" Prefiere planificar y formular estrategias 70% del tiempo."
    ...
    if result_descriptions["V"]["percentage"] ==45: result_descriptions["V"]["description"]=" Grado regular de vigor físico. Tiende a preferir funciones que exijan movimiento limitado."
