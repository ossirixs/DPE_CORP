...
def get_result_descriptions(max_object):
    ...
    if result_descriptions["O"]["percentage"] ==00: result_descriptions["O"]["description"]=" Dificultad en su relacionamiento, es muy formal.  "
    ...
    if result_descriptions["R"]["percentage"] ==00: result_descriptions["R"]["description"]=" Ninguna preocupación en planificación."
